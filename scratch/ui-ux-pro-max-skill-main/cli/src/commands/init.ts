...
export async function initCommand(options: InitOptions): Promise<void> {
  ...
  logger.step(`Installing for: ${chalk.cyan(getAITypeDescription(aiType))}${modeLabel}`);
  ...
  try {
    ...
    console.log();
    logger.done('UI/UX Pro Max installed successfully!');

    // Next steps
    console.log();
    console.log(chalk.bold.hex('#3B82F6')(' Next steps:'));
    console.log(chalk.gray('  1. Restart your AI coding assistant'));
    console.log(chalk.gray('  2. Try: "Build a landing page for a SaaS product"'));
    console.log();
  } catch (error) {
